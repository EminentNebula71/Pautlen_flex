 ...
 */
int insertar_simbolo(TABLA_HASH *th, const char *lexema, int categ, int tipo, int clase, int tam, int n_locales, int pos_local, int n_params, int pos_param) {
    int ind;
    INFO_SIMBOLO *is;
    NODO_HASH *n = NULL;
