...
void yyerror(const char* s) {
	fprintf(stderr, "****Error sintactico en [lin %ld, col %ld]", nlin, ncol);
	return;
}



#line 86 "alfa.tab.c" /* yacc.c:339  */
...
# define YYTOKENTYPE
  enum yytokentype
  {
    OP = 258,
    NUM = 259,
    TOK_PARENTESISIZQUIERDO = 260,
    TOK_PARENTESISDERECHO = 261,
    TOK_ASTERISCO = 262,
    TOK_MAS = 263,
    TOK_MENOS = 264,
    TOK_MENORIGUAL = 265,
...
{
       0,    38,    38,    40,    41,    42,    44,    45,    47,    49,
      50,    52,    54,    55,    57,    58,    61,    63,    64,    67,
      68,    71,    73,    74,    77,    78,    80,    81,    83,    84,
      85,    86,    88,    89,    91,    92,    94,    96,    97,    99,
     101,   103,   108,   109,   110,   111,   112,   113,   114,   115,
     116,   117,   118,   119,   120,   121,   122,   125,   126,   128,
...
{
  "$end", "error", "$undefined", "OP", "NUM", "TOK_PARENTESISIZQUIERDO",
  "TOK_PARENTESISDERECHO", "TOK_ASTERISCO", "TOK_MAS", "TOK_MENOS",
  "TOK_MENORIGUAL", "TOK_MENOR", "TOK_MAYOR", "TOK_IGUAL",
  "TOK_LLAVEDERECHA", "TOK_COMA", "TOK_PUNTOYCOMA", "TOK_RETURN",
  "TOK_DIVISION", "TOK_AND", "TOK_OR", "TOK_TRUE", "TOK_FALSE",
  "TOK_CONSTANTE_ENTERA", "TOK_IDENTIFICADOR", "TOK_BOOLEAN",
  "TOK_CORCHETEDERECHO", "TOK_CORCHETEIZQUIERDO", "TOK_PRINTF",
  "TOK_SCANF", "TOK_MAYORIGUAL", "TOK_FUNCTION", "TOK_DISTINTO",
  "TOK_MAIN", "TOK_ARRAY", "TOK_INT", "TOK_IF", "TOK_ELSE", "TOK_WHILE",
  "TOK_LLAVEIZQUIERDA", "MENOSU", "TOK_NOT", "$accept", "programa",
...
{
      -5,    -4,    34,   -23,   -39,   -39,   -16,   -39,     6,   -23,
      12,   -39,   -39,   -39,    13,   -16,    -7,     6,   -39,   -39,
      25,    40,    36,    12,     2,     2,    12,    55,    56,    48,
      -7,    50,   -39,   -39,    54,   -39,   -39,   -39,   -39,   -39,
       5,   -39,   -39,    12,   -39,    44,    71,     2,   -39,   -39,
       2,     2,   -39,    81,   -39,   -39,   -39,     3,    81,   -39,
       2,     2,   -39,   -39,   -39,     2,     2,     2,   -39,   -39,
     -16,    38,    72,   -39,   -39,     2,     2,     2,     2,     2,
       2,     2,    66,    74,    81,    81,    45,    12,    85,    79,
     -39,     2,     2,     2,    89,     2,    90,   -39,   -39,    20,
      20,   -39,   -39,    20,   152,    98,    70,    76,   -39,   -39,
      77,   -16,   -39,    81,    81,    81,     2,    81,     2,     2,
     -39,   -39,    -7,    -7,   -23,    79,    81,    81,   152,    91,
      97,   -39,    -7,   -39,   -39,    82,   -39,   107,    87,   -39,
      -7,   113,   -39
};
...
{
       0,     0,     0,     0,     1,    10,     0,     9,    15,     3,
       0,     6,     8,     7,     0,     0,     0,    15,     4,    72,
       0,    12,     0,     0,     0,     0,     0,     0,     0,     0,
      24,     0,    27,    28,     0,    32,    33,    29,    30,    31,
       0,    14,     5,     0,    71,     0,     0,     0,    69,    70,
       0,     0,    55,    42,    52,    67,    68,    51,    41,    40,
       0,     0,     2,    25,    26,     0,     0,     0,    13,    11,
      18,     0,     0,    47,    50,     0,     0,     0,     0,     0,
       0,    58,     0,     0,    35,    34,     0,     0,     0,    20,
      53,     0,     0,     0,     0,     0,     0,    54,    46,    43,
      44,    45,    48,    49,    60,     0,     0,     0,    36,    21,
       0,     0,    17,    63,    65,    66,     0,    64,     0,     0,
      57,    56,     0,     0,    23,    20,    61,    62,    60,     0,
...
{
     -39,   -39,    -6,   -39,   -39,   -39,    -1,   -39,    86,   111,
     -39,   -39,   -38,    21,   -39,   -26,   -39,   -39,   -39,   -39,
     -15,   -39,   -39,   -39,   -39,   -39,    73,   -39,     7,   -39,
     -39,   -39,   109,   -10
};
...
static const yytype_int16 yydefgoto[] =
{
      ...
      17,    88,   112,    89,   132,    29,    30,    31,    32,    33,
      52,    35,    36,    37,    38,    39,    53,   105,   120,    72,
      54,    55,    56,    57
};
...
{
      21,    34,     5,    18,    63,    14,    40,    47,    81,     5,
      24,     6,     7,    46,    23,    34,    59,    19,    66,     7,
      40,    25,    26,    48,    49,    44,    19,    75,     1,    27,
      67,    28,    67,    21,     4,     3,    19,    15,    78,    79,
      22,    42,    50,    51,    90,    75,    76,    77,    91,    92,
      93,    94,    75,    76,    77,    43,    78,    79,    80,    44,
      60,    61,    62,    78,    79,    80,    64,    65,    95,    87,
      69,   108,   106,    75,    76,    77,    70,   109,    97,    96,
     107,    75,    76,    77,    78,    79,    80,   133,    75,    76,
      77,   110,    78,    79,    80,   111,   129,   130,    58,    78,
      79,    80,   116,   118,   121,   135,   137,    34,    34,   122,
      87,   136,    40,    40,   141,   123,   124,    34,   131,   138,
      71,   139,    40,    73,    74,    34,   140,   142,    41,    68,
      40,    45,   125,    82,    83,   134,     0,     0,    84,    85,
      86,     0,     0,     0,     0,     0,     0,     0,    98,    99,
     100,   101,   102,   103,   104,     0,     0,     0,     0,    75,
      76,    77,     0,     0,   113,   114,   115,   119,   117,     0,
...
{
      10,    16,    25,     9,    30,     6,    16,     5,     5,    25,
      17,    34,    35,    23,    15,    30,    26,    24,    13,    35,
      30,    28,    29,    21,    22,    23,    24,     7,    33,    36,
      27,    38,    27,    43,     0,    39,    24,    31,    18,    19,
      27,    16,    40,    41,     6,     7,     8,     9,    10,    11,
      12,    13,     7,     8,     9,    15,    18,    19,    20,    23,
       5,     5,    14,    18,    19,    20,    16,    13,    30,    70,
      26,    26,     6,     7,     8,     9,     5,    87,     6,    41,
       6,     7,     8,     9,    18,    19,    20,   125,     7,     8,
       9,     6,    18,    19,    20,    16,   122,   123,    25,    18,
      19,    20,    13,    13,     6,    14,   132,   122,   123,    39,
     111,    14,   122,   123,   140,    39,    39,   132,   124,    37,
      47,    14,   132,    50,    51,   140,    39,    14,    17,    43,
     140,    22,   111,    60,    61,   128,    -1,    -1,    65,    66,
      67,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    75,    76,
      77,    78,    79,    80,    81,    -1,    -1,    -1,    -1,     7,
       8,     9,    -1,    -1,    91,    92,    93,    15,    95,    -1,
...
{
       0,    33,    43,    39,     0,    25,    34,    35,    44,    45,
      46,    47,    48,    49,    48,    31,    51,    52,    44,    24,
      50,    75,    27,    48,    17,    28,    29,    36,    38,    57,
      58,    59,    60,    61,    62,    63,    64,    65,    66,    67,
      75,    51,    16,    15,    23,    74,    75,     5,    21,    22,
      40,    41,    62,    68,    72,    73,    74,    75,    68,    75,
       5,     5,    14,    57,    16,    13,    13,    27,    50,    26,
       5,    68,    71,    68,    68,     7,     8,     9,    18,    19,
      20,     5,    68,    68,    68,    68,    68,    48,    53,    55,
       6,    10,    11,    12,    13,    30,    41,     6,    68,    68,
      68,    68,    68,    68,    68,    69,     6,     6,    26,    75,
       6,    16,    54,    68,    68,    68,    13,    68,    13,    15,
      70,     6,    39,    39,    39,    55,    68,    68,    68,    57,
      57,    44,    56,    54,    70,    14,    14,    57,    37,    14,
      39,    57,    14
};
...
#line 1386 "alfa.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 40 "alfa.y" /* yacc.c:1646  */
    {fprintf(yyout, ";R2:\t<declaraciones> ::= <declaracion>\n");}
#line 1392 "alfa.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 41 "alfa.y" /* yacc.c:1646  */
    {fprintf(yyout, ";R3:\t<declaraciones> ::= <declaracion> <declaraciones>\n");}
#line 1398 "alfa.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 42 "alfa.y" /* yacc.c:1646  */
    {fprintf(yyout, ";R4:\t<declaracion> ::= <clase> <identificadores> ;\n");}
#line 1404 "alfa.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 44 "alfa.y" /* yacc.c:1646  */
    {fprintf(yyout, ";R5:\t<clase> ::= <clase_escalar>\n");}
#line 1410 "alfa.tab.c" /* yacc.c:1646  */
    break;
...
#line 1810 "alfa.tab.c" /* yacc.c:1646  */
      default: break;
    }
