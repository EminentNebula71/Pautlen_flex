...
%token <operador> OP
%token <numero> NUM
%token TOK_PARENTESISIZQUIERDO TOK_PARENTESISDERECHO TOK_ASTERISCO TOK_MAS TOK_MENOS TOK_MENORIGUAL TOK_MENOR TOK_MAYOR TOK_IGUAL TOK_LLAVEDERECHA TOK_COMA TOK_PUNTOYCOMA TOK_RETURN TOK_DIVISION TOK_AND TOK_OR TOK_TRUE TOK_FALSE TOK_CONSTANTE_ENTERA TOK_IDENTIFICADOR TOK_BOOLEAN TOK_CORCHETEDERECHO TOK_CORCHETEIZQUIERDO TOK_PRINTF TOK_SCANF TOK_MAYORIGUAL TOK_FUNCTION TOK_DISTINTO
...
clase: clase_escalar {fprintf(yyout, ";R5:\t<clase> ::= <clase_escalar>\n");} |
       clase_vector {fprintf(yyout, ";R6:\t<clase> ::= <clase_vector>\n");} ;
...
exp: exp TOK_MAS exp {fprintf (yyout, ";R72:\t<exp> ::= <exp> + <exp>\n");} |
     ...
     MENOSU exp {fprintf(yyout, ";R76:\t<exp> ::= - <exp>\n");} |
...
resto_lista_expresiones: TOK_COMA exp resto_lista_expresiones {fprintf(yyout, ";R91:\t<resto_lista_expresiones> ::= , <exp> <resto_lista_expresiones>\n");} |
                        ...
                        ;
comparacion: exp TOK_IGUAL TOK_IGUAL exp {fprintf(yyout, ";R93:\t<comparacion> ::= <exp> == <exp>\n");} |
             exp TOK_NOT TOK_IGUAL exp {fprintf(yyout, ";R94:\t<comparacion> ::= <exp> != <exp>\n");} |
